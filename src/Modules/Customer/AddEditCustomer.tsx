...
const AddEditCustomer: React.FC<IAddEditCustomer> = (props) => {
  ...
  const footer = (
    <React.Fragment>
      ...
      />
      <Button
        data-cy="add-edit-customer-save-btn"
  ...
  return (
    <Dialog
      data-cy="add-edit-customer-dialog"
      visible={show}
      style={{ width: "50rem" }}
      breakpoints={{ "960px": "75vw", "641px": "90vw" }}
      header={isAdd ? "Create customer" : "Update customer"}
      modal
      className="p-fluid"
      footer={footer}
      onHide={closeClick}
    >
      <div className="field">
        ...
        <InputText
          data-cy="add-edit-customer-name"
          id="name"
      ...
      <div className="field">
        ...
        <InputText
          data-cy="add-edit-customer-email"
          id="email"
          type="email"
          disabled={!isAdd}
      ...
      <div className="field">
        ...
        <Dropdown
          data-cy="add-edit-customer-country"
      ...
      <div className="grid">
        <div className="field col-6">
          ...
          <InputNumber
            data-cy="add-edit-customer-anual-salary"
            id="anual-salary"
        ...
        <div className="field col-6">
          ...
          <InputNumber
            data-cy="add-edit-customer-credit-card-debt"
            id="credit-card-debt"
      ...
      <div className="grid">
        <div className="field col-6">
          ...
          <InputNumber
            data-cy="add-edit-customer-net-worth"
            id="net-worth"
        ...
        <div className="field col-6">
          ...
          <InputNumber
            data-cy="add-edit-customer-car-purchase-amount"
